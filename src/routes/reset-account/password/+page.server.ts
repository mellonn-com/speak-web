...
export const actions = {
    default: async ({ request, cookies }) => {
        ...
        try {
            ...
            if (!token) {
                return setError(form, "token", "Some unknown error happened, please try resetting your password again.");
            }
            ...
            if (err instanceof NotFoundException) {
                if (err.code === "password_reset_token_not_found") {
                    ...
                    return setError(form, "token", "This link have expired, please try resetting your password again.")
                }
            }
            console.log(err)
